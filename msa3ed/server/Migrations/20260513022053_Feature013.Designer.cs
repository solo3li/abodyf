...
namespace Uis.Server.Migrations
{
    ...
    [Migration("20260513022053_Feature013")]
    partial class Feature013
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uis.Server.Models.ChatReadReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Uis.Server.Models.ModerationAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Uis.Server.Models.Service", b =>
                {
                    ...
                    b.Property<Guid?>("LastEditedByExecutorId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Uis.Server.Models.SubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Uis.Server.Models.ModerationAction", b =>
                {
                    ...
                    b.HasOne("Uis.Server.Models.Message", "TargetMessage")
                        .WithMany()
                        .HasForeignKey("TargetMessageId");

                    b.HasOne("Uis.Server.Models.User", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Uis.Server.Models.Service", b =>
                {
                    ...
                    b.HasOne("Uis.Server.Models.SubCategory", "SubCategory")
                        .WithMany()
